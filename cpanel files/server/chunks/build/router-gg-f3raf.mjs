import { r as reactExports, j as jsxRuntimeExports, B as RouterCore, D as isRedirect, n as useRouter, E as ErrorComponent, a as createServerFn, l as dummyMatchContext, m as matchContext, u as useRouterState, i as invariant, h as rootRouteId, F as redirect, O as Outlet, d as React2, p as useForwardedRef, w as exactPathTest, x as removeTrailingSlash, y as deepEqual, q as useIntersectionObserver, v as functionalUpdate$1, z as warning, f as getDefaultExportFromCjs, A as isModuleNotFoundError, o as requireReactDom, t as trimPathLeft, k as joinPaths } from "./server.mjs";
import { r as requireAdmin, c as createSsrRpc } from "./middleware-BXaiHw3P.mjs";
...
let Route$A = class Route extends BaseRoute {
  /**
...
const Toaster = /* @__PURE__ */ React2.forwardRef(function Toaster2(props, ref) {
  ...
  const [actualTheme, setActualTheme] = React2.useState(theme !== "system" ? theme : "light");
...
function NotFound({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 p-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-gray-600 dark:text-gray-400", children: children || /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "The page you are looking for does not exist." }) }),
...
function ThemeInitScript() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("script", { id: "theme-init", suppressHydrationWarning: true, children: js });
}
const getTheme = createServerFn().handler(createSsrRpc("71c8991fc9c515da010713bdaa6b8c785cb3e21a16557175130babcfd659f0d8"));
const setTheme = createServerFn({
  ...
  return data;
}).handler(createSsrRpc("08e380ba074146180cab5cf970c6269c0fa27aca786f3aa0c9288cb27cccefbf"));
...
function ThemeProvider({
  ...
  const [theme, setThemeState] = reactExports.useState(initial);
  reactExports.useEffect(() => {
  ...
  reactExports.useLayoutEffect(() => {
    const root = document.documentElement;
    root.classList.remove("light", "dark");
    const applied = theme === "system" ? matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light" : theme;
  ...
  const setTheme$1 = (next) => {
    setThemeState(next);
    localStorage.setItem(LS_KEY, next);
    setTheme({ data: next });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeCtx.Provider, { value: { theme, setTheme: setTheme$1 }, children });
}
const useTheme = () => {
...
const appCss = "/assets/app-C5I6BCl4.css";
const customCss = "/assets/custom-tn0RQdqM.css";
const Route$z = createRootRouteWithContext()({
  ...
  errorComponent: (props) => {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(RootDocument, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DefaultCatchBoundary, { ...props }) });
  },
...
function RootDocument({ children }) {
  const initial = Route$z.useLoaderData();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("html", { lang: "en", className: initial === "system" ? "" : initial, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("head", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeInitScript, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(HeadContent, {})
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("body", { className: "", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(ThemeProvider, { initial, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-svh flex-col", children }),
...
const $$splitComponentImporter$w = () => import("./route-CqvywtvA.mjs");
const Route$y = createFileRoute("/(marketing)")({
  component: lazyRouteComponent($$splitComponentImporter$w, "component")
});
const $$splitComponentImporter$v = () => import("./route-6rQ4IRoI.mjs");
const Route$x = createFileRoute("/(dashboard)")({
  component: lazyRouteComponent($$splitComponentImporter$v, "component")
});
const $$splitComponentImporter$u = () => import("./route-BOy6yCMq.mjs");
const Route$w = createFileRoute("/(admin)")({
  beforeLoad: async () => {
    try {
      await requireAdmin();
    } catch (error) {
...
}).handler(createSsrRpc("f617c6706b8ff2375d4e4dbe588f0a3e7a49cda57c76971602b7b88bb03adb0f"));
const getSeasons = createServerFn({
  method: "GET"
}).handler(createSsrRpc("344a28258d38487bce4805f36ef657e7ef0a51b88d1c434fc9192f106a05ab75"));
const getActiveSeasons = createServerFn({
  method: "GET"
}).handler(createSsrRpc("6d4c6e33d681381c313d6711c469d78b175d2f2f433953bb340a44ff34150a82"));
const $$splitComponentImporter$t = () => import("./index-A9IEAkJy.mjs");
...
function LoadingComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto max-w-6xl px-4 py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-8 w-8 animate-spin text-muted-foreground" }) }) });
}
const $$splitComponentImporter$s = () => import("./index-F3sYptlZ.mjs");
const Route$u = createFileRoute("/(marketing)/")({
  component: lazyRouteComponent($$splitComponentImporter$s, "component")
});
const $$splitComponentImporter$r = () => import("./success-D4Mh4KL3.mjs");
const Route$t = createFileRoute("/register/success")({
  component: lazyRouteComponent($$splitComponentImporter$r, "component"),
  validateSearch: (search) => ({
    registrationId: search.registrationId || ""
  })
});
const $$splitComponentImporter$q = () => import("./_seasonId-Gv2z2PCS.mjs");
...
const Route$s = createFileRoute("/register/$seasonId")({
  loader: async ({
    params,
    context
  }) => {
...
const $$splitComponentImporter$p = () => import("./sign-up-c-ao2kX-.mjs");
const Route$r = createFileRoute("/auth/sign-up")({
  component: lazyRouteComponent($$splitComponentImporter$p, "component")
});
const $$splitComponentImporter$o = () => import("./sign-in-CKvGbh1p.mjs");
const Route$q = createFileRoute("/auth/sign-in")({
  component: lazyRouteComponent($$splitComponentImporter$o, "component")
});
const $$splitComponentImporter$n = () => import("./reset-password-Dli_HPeg.mjs");
const Route$p = createFileRoute("/auth/reset-password")({
  component: lazyRouteComponent($$splitComponentImporter$n, "component")
});
const Route$o = createFileRoute("/api/test")({
  server: {
    handlers: {
      GET: async ({ request }) => {
        return json({
...
const $$splitComponentImporter$m = () => import("./sponsors-q3n9lQ5U.mjs");
const Route$n = createFileRoute("/(marketing)/sponsors")({
  component: lazyRouteComponent($$splitComponentImporter$m, "component")
});
const $$splitComponentImporter$l = () => import("./schedule-BBKZf7Y0.mjs");
const Route$m = createFileRoute("/(marketing)/schedule")({
  component: lazyRouteComponent($$splitComponentImporter$l, "component")
});
const $$splitComponentImporter$k = () => import("./docs-B8DlD7q6.mjs");
const Route$l = createFileRoute("/(marketing)/docs")({
  component: lazyRouteComponent($$splitComponentImporter$k, "component")
});
const $$splitComponentImporter$j = () => import("./contact-DNdmeWGJ.mjs");
const Route$k = createFileRoute("/(marketing)/contact")({
  component: lazyRouteComponent($$splitComponentImporter$j, "component")
});
const $$splitComponentImporter$i = () => import("./about-DqimwTbp.mjs");
const Route$j = createFileRoute("/(marketing)/about")({
  component: lazyRouteComponent($$splitComponentImporter$i, "component")
});
const $$splitComponentImporter$h = () => import("./index-DneL-7DY.mjs");
const Route$i = createFileRoute("/(dashboard)/dashboard/")({
  component: lazyRouteComponent($$splitComponentImporter$h, "component")
});
const $$splitComponentImporter$g = () => import("./index-E1RL111Z.mjs");
const Route$h = createFileRoute("/(admin)/admin/")({
  component: lazyRouteComponent($$splitComponentImporter$g, "component")
});
const Route$g = createFileRoute("/api/auth/$")({
  server: {
    handlers: {
      GET: async ({ request }) => {
...
const $$splitComponentImporter$f = () => import("./_slug-BtWd55Ep.mjs");
const Route$f = createFileRoute("/(marketing)/divisions/$slug")({
  component: lazyRouteComponent($$splitComponentImporter$f, "component")
});
const $$splitComponentImporter$e = () => import("./todos-SGbUdNNA.mjs");
const Route$e = createFileRoute("/(dashboard)/dashboard/todos")({
  component: lazyRouteComponent($$splitComponentImporter$e, "component")
});
const $$splitComponentImporter$d = () => import("./schedule-CHtBW096.mjs");
const Route$d = createFileRoute("/(dashboard)/dashboard/schedule")({
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("./registrations-D6frmLLu.mjs");
const Route$c = createFileRoute("/(dashboard)/dashboard/registrations")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./payments-DuAZi9iC.mjs");
const Route$b = createFileRoute("/(dashboard)/dashboard/payments")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./my-players-DhPtK3Zl.mjs");
const Route$a = createFileRoute("/(dashboard)/dashboard/my-players")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./account-CehFP5mB.mjs");
const Route$9 = createFileRoute("/(dashboard)/dashboard/account")({
...
const $$splitComponentImporter$8 = () => import("./teams-BMxNuB4j.mjs");
const Route$8 = createFileRoute("/(admin)/admin/teams")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./seasons-CsiZ9spz.mjs");
const Route$7 = createFileRoute("/(admin)/admin/seasons")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./registrations-BnlW9wv-.mjs");
const Route$6 = createFileRoute("/(admin)/admin/registrations")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./players-Cuo8qG3G.mjs");
const Route$5 = createFileRoute("/(admin)/admin/players")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./leagues-CYjlTVL7.mjs");
const Route$4 = createFileRoute("/(admin)/admin/leagues")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./games-Ci3a9tNz.mjs");
const Route$3 = createFileRoute("/(admin)/admin/games")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./communications-DmcIyhBe.mjs");
const Route$2 = createFileRoute("/(admin)/admin/communications")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./calendar-BHokVOQk.mjs");
const Route$1 = createFileRoute("/(admin)/admin/calendar")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./announcements-BOQzWVpu.mjs");
const Route2 = createFileRoute("/(admin)/admin/announcements")({
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const marketingRouteRoute = Route$y.update({
  id: "/(marketing)",
  getParentRoute: () => Route$z
});
const dashboardRouteRoute = Route$x.update({
  id: "/(dashboard)",
  getParentRoute: () => Route$z
});
const adminRouteRoute = Route$w.update({
  id: "/(admin)",
  getParentRoute: () => Route$z
});
const RegisterIndexRoute = Route$v.update({
  id: "/register/",
  path: "/register/",
  getParentRoute: () => Route$z
});
const marketingIndexRoute = Route$u.update({
  id: "/",
  path: "/",
  getParentRoute: () => marketingRouteRoute
});
const RegisterSuccessRoute = Route$t.update({
  id: "/register/success",
  path: "/register/success",
  getParentRoute: () => Route$z
});
const RegisterSeasonIdRoute = Route$s.update({
  id: "/register/$seasonId",
  path: "/register/$seasonId",
  getParentRoute: () => Route$z
});
const AuthSignUpRoute = Route$r.update({
  id: "/auth/sign-up",
  path: "/auth/sign-up",
  getParentRoute: () => Route$z
});
const AuthSignInRoute = Route$q.update({
  id: "/auth/sign-in",
  path: "/auth/sign-in",
  getParentRoute: () => Route$z
});
const AuthResetPasswordRoute = Route$p.update({
  id: "/auth/reset-password",
  path: "/auth/reset-password",
  getParentRoute: () => Route$z
});
const ApiTestRoute = Route$o.update({
  id: "/api/test",
  path: "/api/test",
  getParentRoute: () => Route$z
});
const marketingSponsorsRoute = Route$n.update({
  id: "/sponsors",
  path: "/sponsors",
  getParentRoute: () => marketingRouteRoute
});
const marketingScheduleRoute = Route$m.update({
  id: "/schedule",
  path: "/schedule",
  getParentRoute: () => marketingRouteRoute
});
const marketingDocsRoute = Route$l.update({
  id: "/docs",
  path: "/docs",
  getParentRoute: () => marketingRouteRoute
});
const marketingContactRoute = Route$k.update({
  id: "/contact",
  path: "/contact",
  getParentRoute: () => marketingRouteRoute
});
const marketingAboutRoute = Route$j.update({
  id: "/about",
  path: "/about",
  getParentRoute: () => marketingRouteRoute
});
const dashboardDashboardIndexRoute = Route$i.update({
  id: "/dashboard/",
  path: "/dashboard/",
  getParentRoute: () => dashboardRouteRoute
});
const adminAdminIndexRoute = Route$h.update({
  id: "/admin/",
  path: "/admin/",
  getParentRoute: () => adminRouteRoute
});
const ApiAuthSplatRoute = Route$g.update({
  id: "/api/auth/$",
  path: "/api/auth/$",
  getParentRoute: () => Route$z
});
const marketingDivisionsSlugRoute = Route$f.update({
  id: "/divisions/$slug",
  path: "/divisions/$slug",
  getParentRoute: () => marketingRouteRoute
});
const dashboardDashboardTodosRoute = Route$e.update({
  id: "/dashboard/todos",
  path: "/dashboard/todos",
  getParentRoute: () => dashboardRouteRoute
});
const dashboardDashboardScheduleRoute = Route$d.update({
  id: "/dashboard/schedule",
  path: "/dashboard/schedule",
  getParentRoute: () => dashboardRouteRoute
});
const dashboardDashboardRegistrationsRoute = Route$c.update({
  id: "/dashboard/registrations",
  path: "/dashboard/registrations",
  getParentRoute: () => dashboardRouteRoute
});
const dashboardDashboardPaymentsRoute = Route$b.update({
  id: "/dashboard/payments",
  path: "/dashboard/payments",
  getParentRoute: () => dashboardRouteRoute
});
const dashboardDashboardMyPlayersRoute = Route$a.update({
  id: "/dashboard/my-players",
  path: "/dashboard/my-players",
  getParentRoute: () => dashboardRouteRoute
});
const dashboardDashboardAccountRoute = Route$9.update({
  id: "/dashboard/account",
  path: "/dashboard/account",
  getParentRoute: () => dashboardRouteRoute
});
const adminAdminTeamsRoute = Route$8.update({
  id: "/admin/teams",
  path: "/admin/teams",
  getParentRoute: () => adminRouteRoute
});
const adminAdminSeasonsRoute = Route$7.update({
  id: "/admin/seasons",
  path: "/admin/seasons",
  getParentRoute: () => adminRouteRoute
});
const adminAdminRegistrationsRoute = Route$6.update({
  id: "/admin/registrations",
  path: "/admin/registrations",
  getParentRoute: () => adminRouteRoute
});
const adminAdminPlayersRoute = Route$5.update({
  id: "/admin/players",
  path: "/admin/players",
  getParentRoute: () => adminRouteRoute
});
const adminAdminLeaguesRoute = Route$4.update({
  id: "/admin/leagues",
  path: "/admin/leagues",
  getParentRoute: () => adminRouteRoute
});
const adminAdminGamesRoute = Route$3.update({
  id: "/admin/games",
  path: "/admin/games",
  getParentRoute: () => adminRouteRoute
});
const adminAdminCommunicationsRoute = Route$2.update({
  id: "/admin/communications",
  path: "/admin/communications",
  getParentRoute: () => adminRouteRoute
});
const adminAdminCalendarRoute = Route$1.update({
  id: "/admin/calendar",
  path: "/admin/calendar",
  getParentRoute: () => adminRouteRoute
});
const adminAdminAnnouncementsRoute = Route2.update({
  id: "/admin/announcements",
  path: "/admin/announcements",
  getParentRoute: () => adminRouteRoute
});
const adminRouteRouteChildren = {
  adminAdminAnnouncementsRoute,
  adminAdminCalendarRoute,
  adminAdminCommunicationsRoute,
  adminAdminGamesRoute,
  adminAdminLeaguesRoute,
  adminAdminPlayersRoute,
  adminAdminRegistrationsRoute,
  adminAdminSeasonsRoute,
  adminAdminTeamsRoute,
...
const dashboardRouteRouteChildren = {
  dashboardDashboardAccountRoute,
  dashboardDashboardMyPlayersRoute,
  dashboardDashboardPaymentsRoute,
  dashboardDashboardRegistrationsRoute,
  dashboardDashboardScheduleRoute,
  dashboardDashboardTodosRoute,
  dashboardDashboardIndexRoute
};
const dashboardRouteRouteWithChildren = dashboardRouteRoute._addFileChildren(
  dashboardRouteRouteChildren
);
const marketingRouteRouteChildren = {
  marketingAboutRoute,
  marketingContactRoute,
  marketingDocsRoute,
  marketingScheduleRoute,
  marketingSponsorsRoute,
  marketingIndexRoute,
  marketingDivisionsSlugRoute
};
