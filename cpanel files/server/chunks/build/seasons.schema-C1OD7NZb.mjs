import { aE as pgTable, aF as timestamp, aG as text, aK as numeric, aJ as boolean, aL as date, aI as uuid } from "./db-COtzJr4P.mjs";
const seasons = pgTable("seasons", {
  ...
  // JSON string of age groups like ["U6", "U8", "U10", "U12"]
